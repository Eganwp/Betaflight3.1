...
* OSD support & configuration without neededing third party OSD software/firmware
* OLED Displays - Display information on: Battery voltage/current/mAh usage, profile, rate profile, mode, version, sensors, RC, etc
